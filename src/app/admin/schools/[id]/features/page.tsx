...
const FEATURES: FeatureToggleItem[] = [
    ...
    { key: "schemesOfWorkEnabled", label: "Scheme of Work", description: "Curriculum scheme of work planning and AI objectives" },
...
const GROUP_LABELS: Record<string, string> = {
    ...
    schemesOfWorkEnabled: "Academics",
                                ...
                                return (
                                    <div key={feat.key} className="flex items-center justify-between px-6 py-4 hover:bg-gray-50 transition-colors">
                                        ...
                                        <button
                                            ...
                                            className={`relative inline-flex h-6 w-11 shrink-0 items-center rounded-full border-2 border-transparent transition-colors duration-200 ease-in-out focus:outline-none focus:ring-2 focus:ring-primary-500 focus:ring-offset-2 ${isOn ? "bg-primary-600" : "bg-gray-200"}`}
                                            role="switch"
                                            aria-checked={isOn}
                                        >
                                            <span
