...
export default function AISettingsPage() {
        ...
        try {
            ...
            if (response.ok) {
                ...
                if (!data.commentConfig) {
                    data.commentConfig = defaultCommentConfig;
                }
                setSettings(data);
            } else {
    ...
    return (
        <div className="max-w-4xl mx-auto p-6">
            <div className="mb-8">
                <h1 className="text-2xl font-bold text-gray-900 mb-2">AI Comment Settings</h1>
                <p className="text-gray-600">
                    Configure how AI generates teacher and principal comments for report cards.
                </p>
            </div>
                        ...
                        <div className="flex items-center">
                            ...
                            <label htmlFor="useMultiAgent" className="ml-2 block text-sm">
                                ...
                                <span className="text-gray-500 block">
                                    Use specialized AI agents for data collection, analysis, and validation instead of single-agent generation.
                                    Provides more accurate and validated comments.
                                </span>
                            </label>
                        </div>
                    </div>
                    ...
                    <div className="space-y-4">
                        <div>
                            ...
                            <textarea
                                ...
                                onChange={(e) => setSettings({
                                    ...settings,
                                    principalPrompt: e.target.value
                                })}
                                rows={6}
                                className="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500"
