...
export default function DashboardLayout({
    ...
    const [schoolName, setSchoolName] = useState<string>("EduCare");
    const [showNotifications, setShowNotifications] = useState(false);
    const { data: session } = useSession();

    // Mock notifications data
    const [notifications, setNotifications] = useState([
        { id: "1", title: "New student registered", message: "John Doe was added to Primary 1A", time: "5 min ago", read: false },
        { id: "2", title: "Report cards ready", message: "First term report cards are ready for publishing", time: "1 hour ago", read: false },
        { id: "3", title: "Score entry deadline", message: "Score entry for SS3 ends tomorrow", time: "2 hours ago", read: false },
        { id: "4", title: "Fee payment received", message: "₦50,000 received from Adaeze Okonkwo", time: "Yesterday", read: true },
    ]);
    ...
    useEffect(() => {
        const fetchSchool = async () => {
            try {
                ...
                if (response.ok) {
                    ...
                    setSchoolLogo(data.logoUrl || null);
                    setSchoolName(data.name || "EduCare");
                }
            } catch (err) {
        ...
        fetchSchool();
    }, [pathname]); // Refetch when navigating to another page
                ...
                <div className="border-t border-gray-200 p-4">
                    <div className="flex items-center gap-3">
                        <div className="w-10 h-10 bg-primary-100 rounded-full flex items-center justify-center">
                            <span className="text-primary-600 font-semibold">{userInitials}</span>
                        </div>
                    ...
                    <div className="flex items-center justify-between px-4 py-3 lg:px-8">
                        <div className="flex items-center gap-4">
                            ...
                            <div>
                                ...
                                <p className="text-sm text-gray-500">2025/2026 - First Term</p>
                            </div>
                        </div>
                                    ...
                                    <>
                                        ...
                                        <div className="absolute right-0 mt-2 w-80 bg-white rounded-xl shadow-lg border border-gray-200 z-50 overflow-hidden">
                                            ...
                                            <div className="px-4 py-3 bg-gray-50 border-t border-gray-100">
                                                <button className="text-sm text-primary-600 hover:text-primary-800 font-medium w-full text-center">
