...
interface AffectiveTraitsProps {
    traits: Trait[];
    displayOptions?: any;
    sectionStyle?: any;
}

export const AffectiveTraits: React.FC<AffectiveTraitsProps> = ({ traits, displayOptions = {}, sectionStyle = {} }) => {
    ...
    return (
        <View style={[styles.traitsCol, container]}>
            <Text style={[styles.traitsHeader, header]}>AFFECTIVE TRAITS</Text>
            {/* Header Row */}
            <View style={[styles.traitRow, header]}>
                <View style={[styles.traitNameCol, borderOnly]}><Text style={{ fontSize: 8, color: header?.color }}>TRAIT</Text></View>
